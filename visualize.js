...
function setup(choice) {
  ...
  if (choice) {
    ...
    if (choice == 1) bubblesorting(array, array.length);
    else if (choice == 2) mergesorting(array, 0, array.length - 1);
    else if (choice == 3) insertionsorting(array, array.length);
    else if (choice == 4) quicksorting(array, 0, array.length - 1);
    else if (choice == 5) selectionsorting(array, array.length);
  }
}
// *************************************************************************************************************** //
...
async function mergesortalgorithm(array, left, mid, right) {
  ...
  while (l1 <= mid) b[i++] = array[l1++];
  while (l2 <= right) b[i++] = array[l2++];
...
async function quicksorting(array, left, right) {
  ...
  if (left < tempLeft) await quicksorting(array, left, tempLeft - 1);
  if (right > tempRight) await quicksorting(array, tempRight + 1, right);
